...
import "../styles/Page4Avatars.css";
...
const Page4Avatars = () => {
  ...
  return (
    <div className="avatars-container page4">
      <Header
        ...
        <div className="apply-cancel-leave">
          ...
          <div className="leave-form">
            ...
            <div className="form-row date-range">
              <div className="date-field institution-field">
                <label>Institution </label>
                <div className="date-input institution-input">
                  <input type="text" value="xxx-xxx-xx-xx" readOnly />
                </div>
              </div>
              <div className="date-field course-field">
                <label>Course Commencement Date</label>
                <div className="date-input course-input">
                  <input type="text" value="08-Aug-2025" readOnly />
                  <CalendarDropIcon className="calendar-icon" />
                </div>
              </div>
