...
const UploadIcon = ({ className, ...props }) => {
  return (
    <div 
      className={`upload-icon-container ${className || ''}`}
      {...props}
      style={{
        width: '64px',
        height: '64px',
